...
public class CargoBuylPMinCSeedsSlot : MonoBehaviour
{
    ...
    void buyForPerMinute()
    {
        ...
        cSeedsResourceCounter.AddToMineSpeedCounter(buyAmmountCountAccepted);
    ...
    public IEnumerator buyEachSecond()
    {
        ...
        {
            cSeedsResourceCounter.AddToCounter(buyAmmountCountAccepted);
