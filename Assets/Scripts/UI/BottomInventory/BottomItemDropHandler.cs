...
public class BottomItemDropHandler : MonoBehaviour, IDropHandler, System.ICloneable
{
    public BottomInventory _Inventory;
    ...
    public void OnDrop(PointerEventData eventData)
    {
        ...
        if (!RectTransformUtility.RectangleContainsScreenPoint(invPanel, Input.mousePosition) && !RectTransformUtility.RectangleContainsScreenPoint((UpperInventoryPanel as RectTransform), Input.mousePosition) && !RectTransformUtility.RectangleContainsScreenPoint((ShopPanel as RectTransform), Input.mousePosition))
        {
